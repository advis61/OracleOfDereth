...
namespace OracleOfDereth
{
    ...
    internal sealed class ItemSubfilters : IDisposable
    {
        ...
        private static readonly Definition[] Definitions =
        {
            ...
            new Definition("Armor", "Abdomen", 122, 76, (filter, value) => { if (value) filter.ArmorSlots |= ItemInfo.ArmorSlot.Abdomen; }),
            new Definition("Armor", "UArm", 206, 51, (filter, value) => { if (value) filter.ArmorSlots |= ItemInfo.ArmorSlot.UpperArms; }),
            new Definition("Armor", "LArm", 265, 51, (filter, value) => { if (value) filter.ArmorSlots |= ItemInfo.ArmorSlot.LowerArms; }),
            new Definition("Armor", "Hands", 324, 57, (filter, value) => { if (value) filter.ArmorSlots |= ItemInfo.ArmorSlot.Hands; }),
            new Definition("Armor", "ULeg", 389, 51, (filter, value) => { if (value) filter.ArmorSlots |= ItemInfo.ArmorSlot.UpperLegs; }),
            new Definition("Armor", "LLeg", 448, 49, (filter, value) => { if (value) filter.ArmorSlots |= ItemInfo.ArmorSlot.LowerLegs; }),
            new Definition("Armor", "Feet", 505, 44, (filter, value) => { if (value) filter.ArmorSlots |= ItemInfo.ArmorSlot.Feet; }),
