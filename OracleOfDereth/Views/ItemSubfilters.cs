...
namespace OracleOfDereth
{
    ...
    internal sealed class ItemSubfilters : IDisposable
    {
        ...
        private static readonly Definition[] Definitions =
        {
            ...
            new Definition("Weapons", "Slashing", 541, 70, (filter, value) => { filter.ElementSlash = value; }),
            new Definition("Weapons", "Pierce", 619, 64, (filter, value) => { filter.ElementPierce = value; }),
            new Definition("Weapons", "Bludge", 691, 60, (filter, value) => { filter.ElementBludge = value; }),
            new Definition("Weapons", "Flame", 759, 75, (filter, value) => { filter.ElementFire = value; }),
            new Definition("Weapons", "Frost", 842, 70, (filter, value) => { filter.ElementFrost = value; }),
            new Definition("Weapons", "Storm", 920, 64, (filter, value) => { filter.ElementStorm = value; }),
            new Definition("Weapons", "Acid", 992, 60, (filter, value) => { filter.ElementAcid = value; }),
            ...
            new Definition("Armor", "Dexterous", 842, 70, (filter, value) => { filter.ArmorSetDexterous = value; }),
