...
namespace OracleOfDereth
{
    ...
    internal sealed class ItemSubfilters : IDisposable
    {
        ...
        private static readonly Definition[] Definitions =
        {
            ...
            new Definition("Weapons", "War", 349, 42, (filter, value) => { filter.WeaponWar = value; }),
            new Definition("Weapons", "Void", 399, 46, (filter, value) => { filter.WeaponVoid = value; }),
            new Definition("Weapons", "Other", 453, 53, (filter, value) => { filter.WeaponOther = value; }),
            new Definition("Weapons", "TW", 302, 39, (filter, value) => { filter.WeaponTW = value; }),
            new Definition("Weapons", "Bow", 189, 44, (filter, value) => { filter.WeaponBow = value; }),
            new Definition("Weapons", "XBow", 241, 53, (filter, value) => { filter.WeaponXbow = value; }),
            ...
            new Definition("Armor", "Head", 5, 49, (filter, value) => { if (value) filter.ArmorSlots |= ItemInfo.ArmorSlot.Head; }),
            new Definition("Armor", "Chest", 62, 52, (filter, value) => { if (value) filter.ArmorSlots |= ItemInfo.ArmorSlot.Chest; }),
            new Definition("Armor", "Girth", 122, 49, (filter, value) => { if (value) filter.ArmorSlots |= ItemInfo.ArmorSlot.Abdomen; }),
            new Definition("Armor", "Pauldron", 179, 74, (filter, value) => { if (value) filter.ArmorSlots |= ItemInfo.ArmorSlot.UpperArms; }),
            new Definition("Armor", "Bracer", 261, 58, (filter, value) => { if (value) filter.ArmorSlots |= ItemInfo.ArmorSlot.LowerArms; }),
            new Definition("Armor", "Hands", 327, 57, (filter, value) => { if (value) filter.ArmorSlots |= ItemInfo.ArmorSlot.Hands; }),
            new Definition("Armor", "Tasset", 392, 59, (filter, value) => { if (value) filter.ArmorSlots |= ItemInfo.ArmorSlot.UpperLegs; }),
            new Definition("Armor", "Greaves", 459, 68, (filter, value) => { if (value) filter.ArmorSlots |= ItemInfo.ArmorSlot.LowerLegs; }),
            new Definition("Armor", "Feet", 535, 44, (filter, value) => { if (value) filter.ArmorSlots |= ItemInfo.ArmorSlot.Feet; }),
            ...
            new Definition("Clothing", "Pants", 61, 54, (filter, value) => { filter.ClothingPants = value; }),
            new Definition("Clothing", "Full coverage", 125, 110, (filter, value) => { filter.ClothingFullCoverage = value; }),
            new Definition("Clothing", "Partial coverage", 243, 130, (filter, value) => { filter.ClothingPartialCoverage = value; }),
            ...
            new Definition("Cloaks", "4", 95, 26, (filter, value) => { filter.CloakLevel4 = value; }),
            new Definition("Cloaks", "5", 125, 26, (filter, value) => { filter.CloakLevel5 = value; }),
            ...
            new Definition("Cloaks", "Other", 155, 54, (filter, value) => { filter.CloakLevelOther = value; }),
